...
class ParametersPageState extends State<ParametersPage> {
  // Creating the url to redirect to the project page
          ...
          child: Column(
            children: [
                ...
                children: <Widget>[
                  ...
                  SizedBox(
                    ...
                    child: TextField(
                        ...
                        // Every time a change is detected, update the variable stocking the first subnet to scan
                        onChanged: (text) {
                ...
                children: <Widget>[
                  ...
                  SizedBox(
                    ...
                    child: TextField(
                        ...
                        // Every time a change is detected, store the value in the last subnet variable
                        onChanged: (text) {
              ...
              DropdownButton(
                  ...
                  // Store the value of the dropmenu is the scan_mode variable
              ...
              // If the variable is equal to 0 (in string format)
              (scan_mode.toString() == '0')

                  // Then display, the panel to choose the range of ports
                  ? Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        Text(
                  ...
                  // Else display the panel to choose a specific list of ports
                  : Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        Text(
              ...
              Column(
                children: [
                  ...
                  TextButton(
                    ...
                    onPressed: () {
                      // Redirect to the link when the button is pushed
                      _launchUrl();
                    },
